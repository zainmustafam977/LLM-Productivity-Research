...
def createPDF(title, link, summary):
    ...
    # split summary string into list of words
    summaryList = summary.split(" ")

    # go through summarylist and save words to a new string
    # if the new string is longer than 100 characters, print it to the pdf
